...
public class Mi extends View {
    ...
    //camera最大旋转角度
    private float mMaxCameraRotate = 20;
    ...
    public Mi(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public Mi(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
